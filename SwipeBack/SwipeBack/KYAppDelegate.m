...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIViewController *viewController1 = [[KYFirstViewController alloc] initWithNibName:@"KYFirstViewController" bundle:nil];
    UIViewController *viewController2 = [[KYSecondViewController alloc] initWithNibName:@"KYSecondViewController" bundle:nil];
    CXNavigationController *navCtrl1 = [[CXNavigationController alloc] initWithRootViewController:viewController1];
